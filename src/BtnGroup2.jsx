...
const BtnGroup = (_props) => { // export default 
  ...
  return (
    <div className='btn-group' role='group'>
      <button type='button' className={leftBtnClass} onClick={() => setActive('left')}>Left</button>
      <button type='button' className={rightBtnClass} onClick={() => setActive('right')}>Right</button>
    </div>
  );
}
